...
#ifndef incl_RexNetworking_LLOutMessage_h
#define incl_RexNetworking_LLOutMessage_h
...
namespace RexNetworking
{
    ...
    public:
        ...
        LLOutMessage(const LLOutMessage &rhs)
        {
        ...
        LLVariableType CheckNextVariable() const;
        ...
        void MarkReliable() { messageData[0] |= LLFlagReliable; }
        
        /// Marks the message as a resend
        void MarkResend() { messageData[0] |= LLFlagResent; }
        
        /// @return True if this message is flagged as reliable, i.e. if the receiver has to Ack it.
        bool IsReliable() const { return (messageData[0] & LLFlagReliable) != 0;}
        
        /// @return The ID that is associated to this packet type.
        LLMsgID GetMessageID() const { return messageInfo->id; }
    ...
    private: // friend-public:
        void operator=(const LLOutMessage &);
        
        // LLMessageManager manages the internal header fields of the message, but this can't all be done ctor-time.
        friend class LLMessageManager;
