...
#ifndef incl_RexNetworking_LLInMessage_h
#define incl_RexNetworking_LLInMessage_h
...
namespace RexNetworking
{
    ...
    public:
        ...
        LLInMessage(const LLInMessage &rhs);
        ...
        /// @return A pointer to the memory area. The returned memory remains owned by LLInMessage so no need to free it.
        const uint8_t *ReadBuffer(size_t *bytesRead);
        
        /// Check the type of the next variable in the message.
        /// @return LLVariableType enum.
        LLVariableType CheckNextVariableType() const;
        ...
        /// if data is already read (and bytesRead incremented) with ReadBytesUnchecked. Increments bytesRead the right amount also when a LLVarBufferxxx is skipped.
        ...
        const LLMsgID GetMessageID() const { return messageID; }

        void SetMessageInfo(const LLMessageInfo *info);
        ...
        const LLMessageInfo *GetMessageInfo() const { return messageInfo; }
        ...
        void SetMessageID(LLMsgID id);
#endif
    private:
        void operator=(const LLInMessage &);
        ...
        void RequireNextVariableType(LLVariableType type);
        ...
        const LLMessageInfo *messageInfo;
...
#endif // incl_RexNetworking_NetInMessage_h
