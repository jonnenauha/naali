...
TerrainPatchHeader DecodePatchHeader(RexNetworking::BitStream &bits)
{
...
void DecodeTerrainPatch(int *patches, RexNetworking::BitStream &bits, const TerrainPatchHeader &header, int size)
{
